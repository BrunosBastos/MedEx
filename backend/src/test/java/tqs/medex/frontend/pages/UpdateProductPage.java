...
public class UpdateProductPage {
    private static final String IMAGE_URL = "https://lh3.googleusercontent.com/proxy/IkK4-SABrOjuqg5yXrr7oiepiQZCQZc7CDDbyLx-JgLnqLOtVhWjNx_UtiGUpUjhYb1la2YL8XPOhyDnyn_5wZjZiGx95hI1ukYVOxttsmiEYGGPPIFNpm5Br_TuIuHDRcZp801rgRSpPss7rNBq";
    ...
    public void insertInfo(int stock, double price){
        ...
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".MuiButton-containedPrimary")));
    ...
    public void confirmChanges() {
        ...
        driver.findElement(By.cssSelector(".css-1nsnpoi-MuiButtonBase-root-MuiButton-root:nth-child(1) > .MuiButton-label")).click();
    }
